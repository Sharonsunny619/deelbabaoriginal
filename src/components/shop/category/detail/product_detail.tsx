        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
           <div className="flex flex-col gap-3 sm:gap-4 w-full lg:w-1/2">
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[489px] overflow-hidden rounded-[10px] bg-[#edeef1]">
             ...
             <div className="flex gap-2 justify-center bg-[#edeef1] -mt-3 sm:-mt-5   py-2 border-t-[1px] border-gray-300">
              {[1, 2, 3].map((_, index) => (
                <div
                  key={index}
         ...
         <div key={`banner-${AdData[0].id}`} className="mt-6 sm:mt-8 shadow-lg mx-15">
