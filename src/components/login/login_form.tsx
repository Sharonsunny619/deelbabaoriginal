      ...
      <div className="flex-grow flex justify-center items-center ">
        <div className="bg-[#fff] h-[550px] w-2/5 rounded-xl shadow-lg">
          <div className="bg-[#689567]  h-[200px] flex flex-col items-center justify-center  rounded-t-xl rounded-b-full">
            ...
            <p className="text-[44px] -mt-32 text-white">Log In</p>
          </div>
          <div className="flex flex-col items-center justify-center my-10">
            ...
            <Button
              ...
              className="group font-[700] text-[14px]  relative h-9 my-7 mx-7 overflow-hidden rounded-sm bg-white hover:bg-[#689567] border border-[#689567] hover:border-white hover:text-white text-[#689567] px-18 py-4 cursor-pointer transition active:scale-95"
            >
              Create New Account
            </Button>
          </div>
