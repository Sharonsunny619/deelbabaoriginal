...
export default function SelectPayment() {
  ...
  return (
    <>
    <div className="min-h-full bg-[#fdfdf1] flex items-start justify-center px-0 md:px-4 py-8">
  <div className="w-full max-w-7xl flex flex-col gap-8">
    <h1 className="text-2xl sm:text-3xl font-bold">Select Payment option</h1>

    {/* Responsive Grid: Stack on small screens, side-by-side on md+ */}
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      
      {/* Left side: spans 2 columns on medium+ */}
      <div className="md:col-span-2 space-y-6">
        <div className="p-4 bg-white border border-[#A6A6A6] rounded-xl">
          <p className="text-sm text-muted-foreground">
            <span className="font-bold text-black">Bank Offer</span>
            <br />
            10% Instant Offer On SBI Credit Card On A Min Spend Rs 2000 TCA
          </p>
        </div>
        ...
        <div className="p-5 bg-white border rounded-xl">
          ...
          >
            <Label
              htmlFor="upi"
              className="flex items-center text-[18px] sm:text-[20px] font-medium px-4 py-4 gap-3 cursor-pointer"
            >
      ...
      <div className="w-full py-3 bg-white border rounded-xl self-start">
