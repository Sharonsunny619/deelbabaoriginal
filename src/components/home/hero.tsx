...
export default function Hero() {
  ...
  <h2 className="text-white font-semibold text-[18px] tracking-wider mb-5 uppercase">
    Opportunities Waiting For You
  </h2>
  <h1 className="text-4xl md:text-[70px] font-extrabold text-white mb-7">
    One Solution For
    <br />
    All Your Needs
  </h1>
  ...
  <Button className="cursor-pointer  active:scale-95 bg-[#689567] text-white px-40 py-3 h-10 rounded-xl font-semibold transition duration-200">
    Explore
  </Button>
</div>
