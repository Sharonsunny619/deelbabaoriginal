    ...
    <footer className={`bg-[#596F5B] text-white w-full  `}>
      <div className="max-w-10/12 mx-auto px-4 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 ">
           <div className="lg:col-span-1 pt-10   gap-5 flex flex-col items-center md:items-start justify-center">
          ...
          <div className="lg:col-span-1 flex flex-col md:flex-row items-center justify-end gap-5 lg::gap-20 mt-5 md:mb-2 mb-7">
